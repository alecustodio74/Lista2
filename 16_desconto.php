...
<html lang="pt-BR">
  <head>
    ...
    <title>Cálculo Preço e desconto</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
  </head>
  <body>
    <h4>16 - Calcular Preço e desconto</h4>
    <form method="post" action="16_result.php"> <!-- action vai para outra página -->
            <div class="col-3">
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="desconto" class="form-label">Digite a desconto %</label>
